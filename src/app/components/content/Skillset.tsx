  ...
  return (
    <div className=''>
      ...
      <div className='flex flex-row items-center mb-12 '>
          <img src="public/react.svg" className='w-[80px] h-[80px] flex-shrink-0 mr-4'/>
          <div className='flex'>
      ...
      <div className='flex flex-row items-center mb-12'>
          <img src="public/next.svg" className='w-[80px] h-[80px] flex-shrink-0 mr-4'/>
          <div className='flex'>
      ...
      <div className='flex flex-row items-center mb-12'>
          <img src="public/linux.svg" className='w-[80px] h-[80px] flex-shrink-0 mr-4'/>
          <div className='flex'>
      ...
      <div className='flex flex-row items-center mb-12'>
          <img src="public/tailwind.svg" className='w-[80px] h-[80px] flex-shrink-0 mr-4'/>
          <div className='flex'>
      ...
      <div className='flex flex-row items-center mb-12'>
          <img src = "public/git.svg" className='w-[80px] h-[80px] flex-shrink-0 mr-4'/>
          <div className='flex'>
      ...
      <div className='flex flex-row items-center mb-12'>
          <img src = "public/java.svg" className='w-[80px] h-[80px] flex-shrink-0 mr-4'/>
          <div className='flex'>
      ...
      <div className='flex flex-row items-center mb-12'>
          <img src = "public/typescript.svg" className='w-[80px] h-[80px] flex-shrink-0 mr-4'/>
          <div className='flex'>
