    ...
    <div className=''>
        ...
        <div className='flex flex-row align-top space-x-4'>
          <div className='flex flex-col'>
            <div className={`instrument-serif-italic text-4xl mb-2`}>Personal Website</div>
          ...
          <div className='flex flex-col'>
            <div className={`instrument-serif-italic text-4xl mb-2`}>Knights Tour Autosolver</div>
          ...
          <div className='flex flex-col'>
            <div className={`instrument-serif-italic text-4xl mb-2`}>React Typing Game</div>
