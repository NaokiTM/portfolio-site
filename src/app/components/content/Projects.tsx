  ...
  return (
    <div className=''>
        ...
        <div className='flex flex-row align-top space-x-4'>
          ...
          <div className='flex flex-col'>
            <div className={`${instrumentSerif.className} text-4xl mb-2`}>Knights Tour Autosolver</div>
          ...
          <div className='flex flex-col'>
            <div className={`${instrumentSerif.className} text-4xl mb-2`}>React Typing Game</div>
